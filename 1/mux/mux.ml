...
let mux4 s1 s0 a0 a1 a2 a3 =
  let new_a0 = mux2_2 s0 a0 a1 in
  let new_a1 = mux2_2 s0 a2 a3 in
  mux2_2 s1 new_a0 new_a1;;

assert(mux4 false false false true false true = true);;
assert(mux4 false true false true false true = false);;
assert(mux4 true false false true false true = true);;
assert(mux4 true true false true false true = false);;
